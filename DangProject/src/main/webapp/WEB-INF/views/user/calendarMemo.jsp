      ...
      <table border=0>
         ...
         <tr>
            ...
            <td align=center width=300>
               <!-- 월 --> <a
               href="calendarMemo.do?year=<%out.print(year);%>&month=<%out.print(month - 1);%>">◀</a>
               <%
               out.print(month + 1);
               %>월 <a
               href="calendarMemo.do?year=<%out.print(year);%>&month=<%out.print(month + 1);%>">▶</a>
			...
			<tr height=30>
				...
				for (int i = 1; i <= end; i++) { //날짜출력
					...
					try {
						...
						String sql = "SELECT DIARY_YEAR , DIARY_MONTH , DIARY_DAY , A_FEED , A_SNACK , B_DIAGNOSIS , B_VACCIN , C_CLOTHES , C_GROOMING , D_NUTRIENTS , D_POO , E_TRAINNING , E_HOTEL , E_KINDERGARTEN FROM COST WHERE ID  = '"
						+ id + "'";
