...
<body>
	...
	<div>
		...
		<br>
		<div
			style="margin: auto; width: 1300px; height: 1000px; border: 1px solid black; padding: 30px; padding: 5%; box-shadow: 10px 10px 30px #000808;">
			<div
				style="width: 500px; height: 500px; float: left; border: 1px solid black; padding: 30px; box-shadow: 10px 10px 30px #000808;">
				<!--차트가 그려질 부분-->
				<canvas id="myChart1"></canvas>
			</div>
			<div
				style="width: 500px; height: 800px; float: right; border: 1px solid black; padding: 30px; box-shadow: 10px 10px 30px #000808;">
				<div
					style="width: 500px; height: 200px; border: 1px solid black; margin-bottom: 40px;">당신의
					이번달 소비내역은 얼마입니다</div>
				<div
					style="width: 500px; height: 200px; border: 1px solid black; margin-bottom: 40px;">간식소비가
					가장 많네요!멍멍!</div>
				<div style="width: 500px; height: 200px; border: 1px solid black;">저희
