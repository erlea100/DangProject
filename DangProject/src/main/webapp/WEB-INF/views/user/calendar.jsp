	...
	<div class="modal hidden" id="modal">
		...
		<div class="modal-contents" id="modal-contents1-2">
			<form name="diary-history" method="post" action="/diary/saveDiary.do">
				<select style="line-height: 30px;" id="val" class="select"
					name="val" onchange="Change()">
				...
				</select> <input type="submit" id="submit-box" onclick="Submit()" value="저장">
				<div id="d1" style="display: none">
					<input type="number" class="selected-d" name="a_Feed" value="0"
						min="0" max="99999999" placeholder="사료" required />
				</div>
				<div id="d2" style="display: none">
					<input type="number" class="selected-d" name="a_Snack" value="0"
						min="0" max="99999999" placeholder="간식" required />
				</div>
				<div id="d3" style="display: none">
					<input type="number" class="selected-d" name="b_Diagnosis"
						value="0" min="0" max="99999999" placeholder="진료" required />
				</div>
				<div id="d4" style="display: none">
					<input type="number" class="selected-d" name="b_Vaccin" value="0"
						min="0" max="99999999" placeholder="예방주사" required />
				</div>
				<div id="d5" style="display: none">
					<input type="number" class="selected-d" name="c_Grooming" value="0"
						min="0" max="99999999" placeholder="미용" required />
				</div>
				<div id="d6" style="display: none">
					<input type="number" class="selected-d" name="c_Clothes" value="0"
						min="0" max="99999999" placeholder="옷" required />
				</div>
				<div id="d7" style="display: none">
					<input type="number" class="selected-d" name="d_Nutrients"
						value="0" min="0" max="99999999" placeholder="영양제" required />
				</div>
				<div id="d8" style="display: none">
					<input type="number" class="selected-d" name="d_Poo" value="0"
						min="0" max="99999999" placeholder="배변" required />
				</div>
				<div id="d9" style="display: none">
					<input type="number" class="selected-d" name="e_Trainning"
						value="0" min="0" max="99999999" placeholder="훈련" required />
				</div>
				<div id="d10" style="display: none">
					<input type="number" class="selected-d" name="e_Hotel" value="0"
						min="0" max="99999999" placeholder="호텔" required />
				</div>
				<div id="d11" style="display: none">
					<input type="number" class="selected-d" name="e_Kindergarten"
						value="0" min="0" max="99999999" placeholder="유치원" required />
				</div>

				<!-- cost 테이블에 값 넘겨주기  -->
				<input name="id" value="<%=id%>" type="hidden"> <input
					class="date-title" name="date" type="hidden" /> <img id="dangdang"
					src="/resources/imgs/001.gif"> <input class="yearValue"
					name="diary_year" type="hidden" /> <input class="monthValue"
					name="diary_month" type="hidden" /> <input class="dayValue"
					name="diary_day" type="hidden" />
			</form>
		</div>
	</div>
	<!-- 조회용 달력 이동 -->
										...
										.ajax({
											...
											success : function(data) {
												...
												//                  modal-contents1-1
													console.log('데이터없음')
													document
															.getElementById('modal-contents1-1').innerHTML = "";
													console.log('수정완료')
												} else {
													for ( var d in data) {
														$('#modal-contents1-1')
														...
														if (data[d].e_Kindergarten != 0) {
															$(
																	...
																	.append(
																			"<i class='fa-solid fa-heart'></i>"
																					+ "<a id=e_Kindergarten>&nbsp;유치원&nbsp;"
																					+ data[d].e_Kindergarten
																					+ "원"
																					+ "</a>"
																					+ "<br />");
														}
