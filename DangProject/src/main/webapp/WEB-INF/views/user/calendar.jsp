...
<<<<<<< HEAD
              ...
              <%-- <form id="icon_selectDiary" action="/diary/icon_selectDiary.do" method=get >
              <input type="readonly" name="id" value="<%=id%>">
               <input type="readonly" name="date" value="<%=year%><%=month+1%><%=day%>">
              </form>
              
              
              		<c:forEach items="${list}" var="vo">
					<a id="a_Feed">사료 : ${vo.a_Feed+vo.a_Snack }</a><br/>
					
					<a id="b_Diagnosis">진료 : ${vo.b_Diagnosis+vo.b_Vaccin }</a><br/>
					
					<a id="c_Grooming">미용 : ${vo.c_Grooming+vo.c_Clothes}</a><br/>
					
					<a id="d_Nutrients">영양제 : ${vo.d_Nutrients+vo.d_Poo }</a><br/>
					
					<a id="e_Trainning">훈련 : ${vo.e_Trainning+vo.e_Hotel+vo.e_Kindergarten}</a><br/>
...
<<<<<<< HEAD
   ...
   /* this.document.getElementById("icon_selectDiary").submit();  */
