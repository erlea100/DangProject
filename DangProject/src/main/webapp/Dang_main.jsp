		...
		<table>
			<tr class="sa sa-up">
				...
				<img src="/resources/imgs/pngwing.com (22).png"
					></td>
				<td><b>어제 샀던 간식이 얼마였더라? </b><br><br>댕댕 다이어리는 반려동물을 위한 맞춤 솔루션 가계부입니다! 우리 아이의
					식비, 예방접종, 유치원 방문 기록까지 데이터를 통해 한눈에 볼 수 있어요.</td>
			</tr>
			<tr class="sa sa-down">
				<td><b>깔끔한 통계</b><br>지출패턴을 스마트하게 분석 사용 내역을 다양하게 필터링할 수 있으며 기간별로 깔끔한 통계를 제공합니다.
			...
			<tr class="sa sa-right">
				...
				<td><b>입력이 쉬워요!</b><br><br>지출을 입력하면 자동으로 어느 항목의 지출이 많은지 가계 지출 관리 및 변동을 간단히
					파악할 수 있습니다.<br>심플하고 직관적인 아이콘으로 소비 패턴을 한 눈에 확인할 수 있는 것이 가장 큰 장점입니다.</td>
			</tr>
			</table>
	<div class="container">
